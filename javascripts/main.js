...
function refreshLayer() {
    events_wfs.remove();
    events_wfs = GeojsonFromWFS(url, params, styleParams);
    events_wfs.addTo(map);
}
...
function insertWFS(lng, lat, event_name, reported_by) {
    ...
    insertPoint(url_wfs, featuretype, namespace_prefix, namespace_uri, featProperties, geomPropertyName, lng, lat, refreshLayer);
}
